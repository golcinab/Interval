...
public class IntervalTest {
	...
	public void includeIntervalTest() {
		...
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(10, 15, Opening.BOTH_OPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(15, 20, Opening.BOTH_OPENED)));
		assertTrue(bothOpenedPivot.includes(IntervalFactory.createInterval(20, 25, Opening.BOTH_OPENED)));
		assertTrue(bothOpenedPivot.includes(IntervalFactory.createInterval(25, 30, Opening.BOTH_OPENED)));
		assertTrue(bothOpenedPivot.includes(IntervalFactory.createInterval(30, 35, Opening.BOTH_OPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(35, 40, Opening.BOTH_OPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(40, 45, Opening.BOTH_OPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(10, 15, Opening.LEFT_OPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(15, 20, Opening.LEFT_OPENED)));
		assertTrue(bothOpenedPivot.includes(IntervalFactory.createInterval(20, 25, Opening.LEFT_OPENED)));
		assertTrue(bothOpenedPivot.includes(IntervalFactory.createInterval(25, 30, Opening.LEFT_OPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(30, 35, Opening.LEFT_OPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(35, 40, Opening.LEFT_OPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(40, 45, Opening.LEFT_OPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(10, 15, Opening.RIGHT_OPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(15, 20, Opening.RIGHT_OPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(20, 25, Opening.RIGHT_OPENED)));
		assertTrue(bothOpenedPivot.includes(IntervalFactory.createInterval(25, 30, Opening.RIGHT_OPENED)));
		assertTrue(bothOpenedPivot.includes(IntervalFactory.createInterval(30, 35, Opening.RIGHT_OPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(35, 40, Opening.RIGHT_OPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(40, 45, Opening.RIGHT_OPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(10, 15, Opening.UNOPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(15, 20, Opening.UNOPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(20, 25, Opening.UNOPENED)));
		assertTrue(bothOpenedPivot.includes(IntervalFactory.createInterval(25, 30, Opening.UNOPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(30, 35, Opening.UNOPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(35, 40, Opening.UNOPENED)));
		assertFalse(bothOpenedPivot.includes(IntervalFactory.createInterval(40, 45, Opening.UNOPENED)));
		Interval leftOpenedPivot = IntervalFactory.createInterval(20, 35, Opening.LEFT_OPENED);
		assertFalse(leftOpenedPivot.includes(IntervalFactory.createInterval(10, 15, Opening.BOTH_OPENED)));
		assertFalse(leftOpenedPivot.includes(IntervalFactory.createInterval(15, 20, Opening.BOTH_OPENED)));
		assertTrue(leftOpenedPivot.includes(IntervalFactory.createInterval(20, 25, Opening.BOTH_OPENED)));
		assertTrue(leftOpenedPivot.includes(IntervalFactory.createInterval(25, 30, Opening.BOTH_OPENED)));
		assertTrue(leftOpenedPivot.includes(IntervalFactory.createInterval(30, 35, Opening.BOTH_OPENED)));
		assertFalse(leftOpenedPivot.includes(IntervalFactory.createInterval(35, 40, Opening.BOTH_OPENED)));
		assertFalse(leftOpenedPivot.includes(IntervalFactory.createInterval(40, 45, Opening.BOTH_OPENED)));
		assertFalse(leftOpenedPivot.includes(IntervalFactory.createInterval(10, 15, Opening.LEFT_OPENED)));
		assertFalse(leftOpenedPivot.includes(IntervalFactory.createInterval(15, 20, Opening.LEFT_OPENED)));
		assertTrue(leftOpenedPivot.includes(IntervalFactory.createInterval(20, 25, Opening.LEFT_OPENED)));
		assertTrue(leftOpenedPivot.includes(IntervalFactory.createInterval(25, 30, Opening.LEFT_OPENED)));
		assertTrue(leftOpenedPivot.includes(IntervalFactory.createInterval(30, 35, Opening.LEFT_OPENED)));
		assertFalse(leftOpenedPivot.includes(IntervalFactory.createInterval(35, 40, Opening.LEFT_OPENED)));
		assertFalse(leftOpenedPivot.includes(IntervalFactory.createInterval(40, 45, Opening.LEFT_OPENED)));
		assertFalse(leftOpenedPivot.includes(IntervalFactory.createInterval(10, 15, Opening.RIGHT_OPENED)));
		assertFalse(leftOpenedPivot.includes(IntervalFactory.createInterval(15, 20, Opening.RIGHT_OPENED)));
		assertFalse(leftOpenedPivot.includes(IntervalFactory.createInterval(20, 25, Opening.RIGHT_OPENED)));
		assertTrue(leftOpenedPivot.includes(IntervalFactory.createInterval(25, 30, Opening.RIGHT_OPENED)));
		assertTrue(leftOpenedPivot.includes(IntervalFactory.createInterval(30, 35, Opening.RIGHT_OPENED)));
		assertFalse(leftOpenedPivot.includes(IntervalFactory.createInterval(35, 40, Opening.RIGHT_OPENED)));
		assertFalse(leftOpenedPivot.includes(IntervalFactory.createInterval(40, 45, Opening.RIGHT_OPENED)));
		assertFalse(leftOpenedPivot.includes(IntervalFactory.createInterval(10, 15, Opening.UNOPENED)));
		assertFalse(leftOpenedPivot.includes(IntervalFactory.createInterval(15, 20, Opening.UNOPENED)));
		assertFalse(leftOpenedPivot.includes(IntervalFactory.createInterval(20, 25, Opening.UNOPENED)));
		assertTrue(leftOpenedPivot.includes(IntervalFactory.createInterval(25, 30, Opening.UNOPENED)));
		assertTrue(leftOpenedPivot.includes(IntervalFactory.createInterval(30, 35, Opening.UNOPENED)));
		assertFalse(leftOpenedPivot.includes(IntervalFactory.createInterval(35, 40, Opening.UNOPENED)));
		assertFalse(leftOpenedPivot.includes(IntervalFactory.createInterval(40, 45, Opening.UNOPENED)));
		Interval rightOpenedPivot = IntervalFactory.createInterval(20, 35, Opening.RIGHT_OPENED);
		assertFalse(rightOpenedPivot.includes(IntervalFactory.createInterval(10, 15, Opening.BOTH_OPENED)));
		assertFalse(rightOpenedPivot.includes(IntervalFactory.createInterval(15, 20, Opening.BOTH_OPENED)));
		assertTrue(rightOpenedPivot.includes(IntervalFactory.createInterval(20, 25, Opening.BOTH_OPENED)));
		assertTrue(rightOpenedPivot.includes(IntervalFactory.createInterval(25, 30, Opening.BOTH_OPENED)));
		assertTrue(rightOpenedPivot.includes(IntervalFactory.createInterval(30, 35, Opening.BOTH_OPENED)));
		assertFalse(rightOpenedPivot.includes(IntervalFactory.createInterval(35, 40, Opening.BOTH_OPENED)));
		assertFalse(rightOpenedPivot.includes(IntervalFactory.createInterval(40, 45, Opening.BOTH_OPENED)));
		assertFalse(rightOpenedPivot.includes(IntervalFactory.createInterval(10, 15, Opening.LEFT_OPENED)));
		assertFalse(rightOpenedPivot.includes(IntervalFactory.createInterval(15, 20, Opening.LEFT_OPENED)));
		assertTrue(rightOpenedPivot.includes(IntervalFactory.createInterval(20, 25, Opening.LEFT_OPENED)));
		assertTrue(rightOpenedPivot.includes(IntervalFactory.createInterval(25, 30, Opening.LEFT_OPENED)));
		assertFalse(rightOpenedPivot.includes(IntervalFactory.createInterval(30, 35, Opening.LEFT_OPENED)));
		assertFalse(rightOpenedPivot.includes(IntervalFactory.createInterval(35, 40, Opening.LEFT_OPENED)));
		assertFalse(rightOpenedPivot.includes(IntervalFactory.createInterval(40, 45, Opening.LEFT_OPENED)));
		assertFalse(rightOpenedPivot.includes(IntervalFactory.createInterval(10, 15, Opening.RIGHT_OPENED)));
		assertFalse(rightOpenedPivot.includes(IntervalFactory.createInterval(15, 20, Opening.RIGHT_OPENED)));
		assertTrue(rightOpenedPivot.includes(IntervalFactory.createInterval(20, 25, Opening.RIGHT_OPENED)));
		assertTrue(rightOpenedPivot.includes(IntervalFactory.createInterval(25, 30, Opening.RIGHT_OPENED)));
		assertTrue(rightOpenedPivot.includes(IntervalFactory.createInterval(30, 35, Opening.RIGHT_OPENED)));
		assertFalse(rightOpenedPivot.includes(IntervalFactory.createInterval(35, 40, Opening.RIGHT_OPENED)));
		assertFalse(rightOpenedPivot.includes(IntervalFactory.createInterval(40, 45, Opening.RIGHT_OPENED)));
		assertFalse(rightOpenedPivot.includes(IntervalFactory.createInterval(10, 15, Opening.UNOPENED)));
		assertFalse(rightOpenedPivot.includes(IntervalFactory.createInterval(15, 20, Opening.UNOPENED)));
		assertTrue(rightOpenedPivot.includes(IntervalFactory.createInterval(20, 25, Opening.UNOPENED)));
		assertTrue(rightOpenedPivot.includes(IntervalFactory.createInterval(25, 30, Opening.UNOPENED)));
		assertFalse(rightOpenedPivot.includes(IntervalFactory.createInterval(30, 35, Opening.UNOPENED)));
		assertFalse(rightOpenedPivot.includes(IntervalFactory.createInterval(35, 40, Opening.UNOPENED)));
		assertFalse(rightOpenedPivot.includes(IntervalFactory.createInterval(40, 45, Opening.UNOPENED)));
		Interval unopenedOpenedPivot = IntervalFactory.createInterval(20, 35, Opening.UNOPENED);
		assertFalse(unopenedOpenedPivot.includes(IntervalFactory.createInterval(10, 15, Opening.BOTH_OPENED)));
		assertFalse(unopenedOpenedPivot.includes(IntervalFactory.createInterval(15, 20, Opening.BOTH_OPENED)));
		assertTrue(unopenedOpenedPivot.includes(IntervalFactory.createInterval(20, 25, Opening.BOTH_OPENED)));
		assertTrue(unopenedOpenedPivot.includes(IntervalFactory.createInterval(25, 30, Opening.BOTH_OPENED)));
		assertTrue(unopenedOpenedPivot.includes(IntervalFactory.createInterval(30, 35, Opening.BOTH_OPENED)));
		assertFalse(unopenedOpenedPivot.includes(IntervalFactory.createInterval(35, 40, Opening.BOTH_OPENED)));
		assertFalse(unopenedOpenedPivot.includes(IntervalFactory.createInterval(40, 45, Opening.BOTH_OPENED)));
		assertFalse(unopenedOpenedPivot.includes(IntervalFactory.createInterval(10, 15, Opening.LEFT_OPENED)));
		assertFalse(unopenedOpenedPivot.includes(IntervalFactory.createInterval(15, 20, Opening.LEFT_OPENED)));
		assertTrue(unopenedOpenedPivot.includes(IntervalFactory.createInterval(20, 25, Opening.LEFT_OPENED)));
		assertTrue(unopenedOpenedPivot.includes(IntervalFactory.createInterval(25, 30, Opening.LEFT_OPENED)));
		assertTrue(unopenedOpenedPivot.includes(IntervalFactory.createInterval(30, 35, Opening.LEFT_OPENED)));
		assertFalse(unopenedOpenedPivot.includes(IntervalFactory.createInterval(35, 40, Opening.LEFT_OPENED)));
		assertFalse(unopenedOpenedPivot.includes(IntervalFactory.createInterval(40, 45, Opening.LEFT_OPENED)));
		assertFalse(unopenedOpenedPivot.includes(IntervalFactory.createInterval(10, 15, Opening.RIGHT_OPENED)));
		assertFalse(unopenedOpenedPivot.includes(IntervalFactory.createInterval(15, 20, Opening.RIGHT_OPENED)));
		assertTrue(unopenedOpenedPivot.includes(IntervalFactory.createInterval(20, 25, Opening.RIGHT_OPENED)));
		assertTrue(unopenedOpenedPivot.includes(IntervalFactory.createInterval(25, 30, Opening.RIGHT_OPENED)));
		assertTrue(unopenedOpenedPivot.includes(IntervalFactory.createInterval(30, 35, Opening.RIGHT_OPENED)));
		assertFalse(unopenedOpenedPivot.includes(IntervalFactory.createInterval(35, 40, Opening.RIGHT_OPENED)));
		assertFalse(unopenedOpenedPivot.includes(IntervalFactory.createInterval(40, 45, Opening.RIGHT_OPENED)));

		assertFalse(unopenedOpenedPivot.includes(IntervalFactory.createInterval(10, 15, Opening.UNOPENED)));
		assertFalse(unopenedOpenedPivot.includes(IntervalFactory.createInterval(15, 20, Opening.UNOPENED)));
		assertTrue(unopenedOpenedPivot.includes(IntervalFactory.createInterval(20, 25, Opening.UNOPENED)));
		assertTrue(unopenedOpenedPivot.includes(IntervalFactory.createInterval(25, 30, Opening.UNOPENED)));
		assertTrue(unopenedOpenedPivot.includes(IntervalFactory.createInterval(30, 35, Opening.UNOPENED)));
		assertFalse(unopenedOpenedPivot.includes(IntervalFactory.createInterval(35, 40, Opening.UNOPENED)));
		assertFalse(unopenedOpenedPivot.includes(IntervalFactory.createInterval(40, 45, Opening.UNOPENED)));
